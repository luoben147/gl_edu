...
class TestVod {
    ...
    void test1() {
        ...
        //3.向request对象设置视频id
        request.setVideoId("79537e304e8a40e58dfaf8c383fa7f26");
        //4.调用初始化对象里的方法，传递request，获取数据
        try {
    ...
    void test3(){
        ...
        //本地文件路径和名称
        String fileName="E:/BaiduYunDownload/java后端/在线教育/项目资料/1-阿里云上传测试视频/6 - What If I Want to Move Faster.mp4";
